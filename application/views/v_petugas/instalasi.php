<div class="container-fluid">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-9">
                    <form method="POST" action="<?= base_url('petugas/instalasi/filter_instalasi'); ?>" class="form-inline">
                ...
                <div class="col-3">
                    <?php echo form_open('petugas/instalasi/search') ?>
                ...
                <td>
                    <center>
                        <?php if ($i->id_petugas == NULL) { ?>
                            <a class="btn btn-sm btn-primary" href="<?php echo base_url('petugas/instalasi/update_data/' . $i->id_instalasi) ?>"><i class="fas fa-edit"></i></a>
                            <a onclick="return confirm ('Yakin Hapus')" class="btn btn-sm btn-danger" href="<?php echo base_url('petugas/instalasi/delete_data/' . $i->id_instalasi) ?>"><i class="fas fa-trash"></i></a>
                        <?php } else { ?>
                            <a class="btn btn-sm btn-success" href="<?php echo base_url('petugas/instalasi/detail_data/' . $i->id_instalasi) ?>"><i class="fas fa-search-plus"></i></a>
                            <a class="btn btn-sm btn-primary" href="<?php echo base_url('petugas/instalasi/update_data/' . $i->id_instalasi) ?>"><i class="fas fa-edit"></i></a>
                            <a onclick="return confirm ('Yakin Hapus')" class="btn btn-sm btn-danger" href="<?php echo base_url('petugas/instalasi/delete_data/' . $i->id_instalasi) ?>"><i class="fas fa-trash"></i></a>
                        <?php } ?>
                    </center>
