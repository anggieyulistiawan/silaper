...
<title>Laporan Data Instalasi</title>
...
<div class="container-fluid">
    ...
    <center>
        <table class="kop">
            <td style="font-size: 30px; font-weight: bold;">Laporan Data Instalasi</td>
        </table>
    </center>
    <div>
            ...
            <tbody style="line-height: 30px;">
                ...
                foreach ($print_instalasi as $i) : ?>
                    <tr>
                        ...
                        <td><?php echo date('d-m-Y', strtotime($i->tanggal_instal)); ?></td>
                        <td><?php echo $i->keterangan_instal ?></td>
    ...
    <div class="ttd" style="display: inline-block;">
        ...
        <br>
        <br>
        <h5 style="margin-bottom: 1px;">Muhammad Fariz Adani, SKom</h5>
        <hr size="2px" color="black" style="margin-top: 1px;">
