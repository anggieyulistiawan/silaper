<div class="container-fluid">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-9">
                    <form method="POST" action="<?= base_url('admin/perbaikan/filter_perbaikan'); ?>" class="form-inline">
                ...
                <div class="col-3">
                    <?php echo form_open('admin/perbaikan/search') ?>
            ...
            <tr>
                ...
                <td>
                    <center>
                        ...
                        <?php } else { ?>
                            <a class="btn btn-sm btn-success" href="<?php echo base_url('admin/perbaikan/detail_data/' . $p->id_perbaikan) ?>"><i class="fas fa-search-plus"></i></a>
                        <?php } ?>
                    </center>
                </td>
            </tr>
