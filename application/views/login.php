...
<body style="background-image: url('assets/img/bg1.jpg');height: 100%;background-position: inherit;background-repeat: no-repeat;background-size: cover;">
                            ...
                            <div class="col-lg-12">
                                <div class="p-4">
                                    <div class="text-center">
                                        ...
                                        <h3 class="text-gray-900 mb-4">RSD Idaman Divisi IT</h3>
                                    </div>
